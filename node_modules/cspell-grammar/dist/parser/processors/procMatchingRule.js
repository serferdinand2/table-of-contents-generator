 ...
 */
export function applyCaptureToBeginOrMatch(matchRuleResult) {
 ...
 */
export function applyCaptureToEnd(rule, match) {
    const { pattern } = rule;
 ...
 * @param rule - the matching rule
 */
export function applyCaptures(rule, match, captures) {
